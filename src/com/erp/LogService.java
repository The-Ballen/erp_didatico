...
public class LogService {
    private static final String LOG_DIR = "database/";
        ...
        try {
            if (!file.exists()) {
                ...
                try (BufferedWriter writer = new BufferedWriter(new FileWriter(file, true))) {
                    writer.write("Tipo,PessoaID,ProdutoID,Quantidade,Data,Hora");
                    writer.newLine();
                }
            }
        } catch (IOException e) {
    ...
    private static void log(String tipo, String pessoaId, String produtoID, int quantidade) {
        ...
        String linha = tipo + "," + pessoaId + "," + produtoID + "," + quantidade + "," + data + "," + hora;
    ...
    public static void VerLog(Scanner scanner) {
        try {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
                ...
                if (line == null) {
                    System.out.println("Aviso: Cabeçalho não encontrado!");
                } else {
